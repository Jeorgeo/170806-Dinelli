			...
			<div class="box-content clearfix">
				...
				<div class="row clearfix">
					<div class="cols col-3 col-md-6 left_side">
						<a class="service__card" href="<?php echo get_field('yd'); ?>">
							<img src="<?php echo get_field('yd_img'); ?>">
						</a>
					</div>
					<div class="cols col-3 col-md-6">
						<a class="service__card" href="<?php echo get_field('ga'); ?>">
							<img src="<?php echo get_field('ga_img'); ?>">
						</a>
					</div>
					<div class="cols col-3 col-md-6 right_side">
						<a class="service__card" href="<?php echo get_field('seo'); ?>">
							<img src="<?php echo get_field('seo_img'); ?>">
						</a>
					</div>
					<div class="cols col-3 col-md-6 left_side">
						<a class="service__card" href="<?php echo get_field('site'); ?>">
							<img src="<?php echo get_field('site_img'); ?>">
						</a>
					</div>
					<div class="cols col-3 col-md-6">
						<a class="service__card" href="<?php echo get_field('youtube'); ?>">
							<img src="<?php echo get_field('youtube_img'); ?>">
						</a>
					</div>
					<div class="cols col-3 col-md-6 right_side">
						<a class="service__card" href="#" onclick="showPopup()">
							<img src="<?php echo get_field('vk_img'); ?>">
						</a>
					</div>
					<div class="cols col-3 col-md-6 left_side">
						<a class="service__card" href="#" onclick="showPopup()">
							<img src="<?php echo get_field('fb_img'); ?>">
						</a>
					</div>
				</div>
			</div>
