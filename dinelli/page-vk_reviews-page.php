			...
			<div class="box-content">
				...
				<div class="row clearfix">
					...
					function get_vk_topik(){
						...
						$board_getComments = 'https://api.vk.com/method/board.getComments?group_id=55517976&topic_id=28357561&count=100&access_token='.$token.'&v=5.60';
						...
						if(!empty($board_getComments_result)){
							...
							if(!empty($board_getComments_result_arr->response->items)){
								...
								if(!empty($from_ids)){
									...
									$users_get = 'https://api.vk.com/method/users.get?user_ids='.$from_ids.'&fields=photo_id,photo_50,photo_100,photo_200_orig,photo_200,photo_400_orig,photo_max,photo_max_orig,sex,city,country,home_town,nickname,screen_name,maiden_name&access_token='.$token.'&v=5.60';
