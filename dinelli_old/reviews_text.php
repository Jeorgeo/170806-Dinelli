<?php
/* Template Name: Письменные отзывы */ 
?><?php get_header(); ?>
	<?php /*
		if (have_posts()){
...
?>
				...
				<div class="content-padding">
					...
					<div class="reviews-items">
						<?php get_reviews_text(); ?>


						<?php /*
						<div class="col-md-6 col-sm-6 col-xs-12 wow bounceIn">
							<div class="reviews-item">
								<div class="reviews-item-title">Альтона-мебель</div>
								<div class="reviews-item-row reviews-item-row-1">
									<div class="reviews-item-row-title">Затраты</div>
									<div class="reviews-item-row-price">25 т.р.</div>
								</div>
								<div style="clear:both;"></div>
								<div class="reviews-item-row reviews-item-row-2">
									<div class="reviews-item-row-title">Прибыль</div>
									<div class="reviews-item-row-price">0 т.р.</div>
									<div class="reviews-item-row-arrow"></div>
									<div class="reviews-item-row-profit">150 т.р.</div>
								</div>
								<div style="clear:both;"></div>
								<div class="reviews-item-row reviews-item-row-3">
									<div class="reviews-item-row-title">Конверсия</div>
									<div class="reviews-item-row-price">0%</div>
									<div class="reviews-item-row-arrow"></div>
									<div class="reviews-item-row-profit">5,9%</div>
								</div>
								<div style="clear:both;"></div>
								<div class="reviews-item-desc">
									Решил заняться новой для себя нишей, и на начальном этапе задача привлечение клиентов. Способ – создание сайта и настройка контекстной рекламы. Выбирал очень щепетильно, так как наслышан о... <a href="#">читать далее</a>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12 wow bounceIn">
					...
					<?php
						if(get_reviews_count('reviews_text') > get_reviews_per_page('reviews_text') ){ 
					?>
					<div class="reviews-items-more">
						<input type="hidden" id="reviews-items-paged" value="0">
						<a href="#" class="dinelli_button" style="margin: 0 auto;" onclick="get_reviews('reviews_text'); return false;">Показать еще</a>
